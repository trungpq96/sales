                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Edit Position</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-6 my-0">             
                                    <form action="{{route('edit_position',$position->id)}}"  method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" rows="5" id="description" name="description"
                                                placeholder="Description">{{$position->description}}</textarea>
                                        </div>
                                        <div class="mb-3">
