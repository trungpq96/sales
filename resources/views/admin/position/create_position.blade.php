            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Create Position</li>
                    </ol>
                </nav>
                @include('admin.nav')
            </div>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Create Position</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-6 my-0"  style="margin-top: -5% !important;">             
                                    <form action="{{route('crt_position')}}"  method="POST">
                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                                        <div class="mb-3 mt-3">
                                            <label for="name_position" class="form-label">Name Position : </label>
                                            <input type="text" class="form-control" id="name_position"
                                                placeholder="Name Position" name="name_position">
                                        </div>
                                        <div class="mb-3">
