      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a style="text-decoration: none" href="{{route('lst_order')}}">List order</a></li>
          </ol>        
        </nav>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  @foreach($orders as $order)                 
                    <tr>
                      ...
                      <td><a href="{{route('order_detail',$order->id)}}"><i class="fas fa-info-circle"></i></a></td>                
                    </tr>                   
                    @endforeach
                  </tbody>
                </table>      
