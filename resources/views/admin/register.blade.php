                            ...
                            <div class="card-body">
                                <form action="{{route('register_admin')}}" method="POST">
                                    ...
                                    <div class="input-group input-group-outline my-3">
                                        ...
                                        <input type="number" class="form-control" name="number_phone" id="number_phone" required>
                                    </div>
                                    <div class="input-group input-group-outline my-3">
                                    ...
                                    <input type="text" name="status" value="Active" id="status" style="display:none">
