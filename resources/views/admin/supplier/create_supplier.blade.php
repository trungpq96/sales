                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Create Supplier</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-6 my-0"  style="margin-top: -5% !important;">             
                                    <form action="{{route('crt_supplier')}}"  method="POST">
                                        ...
                                        <div class="mb-3 mt-3">
                                            <label for="address_supplier" class="form-label">Adress Supplier : </label>
                                            <input type="text" class="form-control" id="address_supplier"
                                                placeholder="Adress Supplier" name="address_supplier">
                                        </div>
                                        <div class="mb-3 mt-3">
