            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">List Payment</li>
                    </ol>
                </nav>
                @include('admin.nav')
            </div>
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2">
                            <div class="table-responsive p-6 my-0"  style="margin-top: -5% !important;">             
                                    <form action="{{route('crt_payment')}}"  method="POST">
                                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                                        <div class="mb-3 mt-3">
                                            <label for="name_payment" class="form-label">Name Payment : </label>
                                            <input type="text" class="form-control" id="name_payment"
