    ...
    <section class="header-style-1">
        <div class="header-big">
            <div class="header-items-active">
                <div class="single-header-item bg_cover"
                    style="background-image: url(./public/assets/img/header-1/header-big-1.jpg);">
                ...
                <div class="single-header-item bg_cover"
                    style="background-image: url(./public/assets/img/header-1/header-big-2.jpg);">
                    <div class="header-item-content">
                        <h3 class="title">Don’t say it with flowers: A NOMOS watch is a gift that lasts</h3>
                        <a href="javascript:void(0)" class="link">Our Valentine's Day collection</a>
                    </div>
        ...
        <div class="header-min">
            <div class="header-min-item product-style-25 bg_cover"
                style="background-image: url(./public/assets/img/header-1/header-min-1.jpg);">
                <div class="product-content">
                    <h4 class="title"><a href="product-details-page.html">Metro 38 Date</a></h4>
                    <p>Reference 1102</p>
                    <a href="javascript:void(0)" class="main-btn primary-btn-border"> <img src="./public/assets/img/icon-svg/cart-5.svg" alt="">$
                        399</a>
                </div>
            </div>
            <div class="header-min-item product-style-25 bg_cover"
                style="background-image: url(./public/assets/img/header-1/header-min-2.jpg);">
                <div class="product-content">
                    <h4 class="title"><a href="product-details-page.html">Metro 38 Date</a></h4>
                    <p>Reference 1102</p>
                    <a href="javascript:void(0)" class="main-btn primary-btn-border"> <img src="./public/assets/img/icon-svg/cart-5.svg" alt="">$
                    ...
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-1/product-1.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-1/product-2.jpg" alt="product">
                                </div>
                            </div>
                        ...
                        <div class="product-content text-center">
                            ...
                            <a href="javascript:void(0)" class="main-btn secondary-1-btn">
                                <img src="./public/assets/img/icon-svg/cart-7.svg" alt="">
                                $ 399
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-1/product-5.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-1/product-6.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-1/product-3.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-1/product-4.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-1/product-7.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-1/product-8.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-1/product-9.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-1/product-10.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-1/product-11.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-1/product-12.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-4/product-1.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-4/product-2.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-4/product-3.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-4/product-4.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-4/product-5.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-4/product-6.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-4/product-7.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-4/product-8.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-4/product-9.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-4/product-10.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="./public/assets/img/product-4/product-11.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="./public/assets/img/product-4/product-12.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
